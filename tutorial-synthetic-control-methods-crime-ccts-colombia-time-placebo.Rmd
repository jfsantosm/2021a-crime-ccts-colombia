...
dataprep.out <- dataprep(
 ...
 predictors = c(5:18),
 predictors.op = "mean",
 time.predictors.prior = c(2004),
 special.predictors = list(
list("errad_aerea"  ,c(2004), "mean"), 
list("lag.ataqinst_ELN" ,c(2004), "mean"),
list("lag.H_coca" ,c(2004), "mean"), 
list("lag.errad_manual" ,c(2004), "mean"), 
list("H_Coca_mayor3" ,c(2004), "mean"), 
list("lag.DF_gast_inv" ,c(2004), "mean"), 
list("errad_manual" ,c(2004), "mean"), 
list("lag.lotes_coca" ,c(2004), "mean"), 
list("lotes_coca" ,c(2004), "mean"), 
list("lag.g_terreno" ,c(2004), "mean"), 
list("imr" ,c(2004), "mean"), 
list("lag.gini" ,c(2004), "mean"), 
list("Litr" ,c(2004), "mean"), 
#list("lag.eb_pir" ,c(2010), "mean"), 
list("eb_mr2" ,c(2004), "mean")),
dependent = "eb_mr_fil",
